...
export function Composer() {
  ...
  function onFilesSelected(selected: FileList | null) {
    ...
    // Keep UX simple: append and allow remove.
  ...
  async function onSend() {
    ...
    // Clean up previews and clear selection.
    ...
    <div className="border-t bg-card/70 backdrop-blur supports-[backdrop-filter]:bg-card/60">
      <div className="mx-auto max-w-3xl px-4 py-4">
        ...
        <div className="flex items-end gap-2">
          ...
          <div className="flex-1">
            <Textarea
              ...
              onKeyDown={onKeyDown}
              placeholder="Message StartKoro… (Enter to send, Shift+Enter for new line)"
              rows={1}
        ...
        <div className="mt-2 text-[11px] text-muted-foreground">
          Tip: Press <span className="font-mono">Shift</span>+<span className="font-mono">Enter</span> for a new line.
        </div>
      </div>
    </div>
  );
