...
import { Globe2, Menu, Shield, Sparkles, User } from "lucide-react";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
export function Navbar() {
  ...
  function toggleLanguage(): void {
    const nextLanguage = i18n.language === "en" ? "bn" : "en";
  ...
  const productLinks = [
    { label: t("navbar.knowledgeBase"), href: isHome ? "#knowledge-base" : "/#knowledge-base", kind: "anchor" as const },
    { label: t("navbar.aiAssistant"), href: "/chat", kind: "assistant" as const },
        ...
        <div className="flex min-h-[74px] items-center justify-between gap-4 px-4 sm:px-6 lg:px-7">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <div className="hidden items-center gap-2 rounded-full border border-emerald-200 bg-emerald-50 px-3 py-2 text-xs font-medium text-emerald-700 xl:flex">
              ...
              {t("navbar.workspaceBadge")}
            </div>
            <Button
              variant="outline"
              className="hidden rounded-full border-slate-200 bg-white px-3 text-slate-800 shadow-sm hover:bg-slate-50 sm:inline-flex"
            ...
            {!user ? (
              ...
              <>
                ...
                >
                  <Link to="/chat">{t("navbar.askAI")}</Link>
                </Button>
                <DropdownMenu>
        ...
        <DialogContent className="left-auto right-0 top-0 h-screen w-[86vw] max-w-[340px] translate-x-0 translate-y-0 rounded-none border-l border-r-0 border-t-0 border-b-0 p-0 shadow-[0_20px_60px_rgba(15,23,42,0.22)]">
          <div className="flex h-full flex-col bg-white">
            <div className="border-b border-slate-200 px-5 py-5">
              ...
              <div className="mt-1 text-sm text-slate-500">{t("navbar.tagline")}</div>
            </div>
